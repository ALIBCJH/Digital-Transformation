    ...
    def handle(self, *args, **options):
        ...
        with connection.schema_editor() as schema_editor:
            ...
            from core.models import (
                OrganizationNode, Altar, User, UserProfile, 
                AttendanceLog, Guest, MemberTransferHistory
            )
            
            models = [
                User, UserProfile, OrganizationNode, Altar,
                AttendanceLog, Guest, MemberTransferHistory
            ]
        ...
        self.stdout.write(
            self.style.SUCCESS('Successfully set up CI database')
        )
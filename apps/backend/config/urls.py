...
from core.views import (
    ...
    LogoutView, MemberListView, RegionalDashboardView, AltarDashboardView, MemberTransferView,
    SuperAdminRegisterView, SuperAdminDashboardView, GetMembersForAttendanceView, BulkAttendanceView
)
...
urlpatterns = [
    ...
    path('api/superadmin/create/', SuperAdminRegisterView.as_view(), name='superadmin_create'),  # Regional/sub-regional superadmin
    ...
    path('api/attendance/members/', GetMembersForAttendanceView.as_view(), name='get_members_for_attendance'),
    path('api/attendance/record/', BulkAttendanceView.as_view(), name='bulk_attendance'),
